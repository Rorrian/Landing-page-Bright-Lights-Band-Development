...
//
// import {calcTotalCartSum} from "../script.js";
//================================================================================================================================================================================================================================================================================================================================
...
function changeQuantity(e) {
    let targetElement = e.target;
    //Если нажатие прошло по одной из кнопок изменения количества
    if (targetElement.closest('.quantity__button')) {
        //Ищем родителя и у него ищем input и получаем его значение
        ...
        //Если нажатая кнопка +, то увеличиваем количества
        ...
        //Снова ищем родителя, у него ипут и меняем в нем значение на новое
...
function calcTotalCartSum() {
    ...
    for (let i = 0; i < productQuantity.length; i++) {
        totalSumValue = totalSumValue + Number(productQuantity[i].value) * Number(productPrices[i].innerHTML);
    }
